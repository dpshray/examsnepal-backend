...
class AdminStoreQuestionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            "explanation_image" => 'sometimes|nullable|image',
            "option_a_image" => 'sometimes|nullable|image',
            "option_b_image" => 'sometimes|nullable|image',
            "option_c_image" => 'sometimes|nullable|image',
            "option_d_image" => 'sometimes|nullable|image',
